#
# Module manifest for module 'StageCoder'
#
...
GUID = '26f46b8a-f449-4cba-b611-4debe86226a9'
...
Description = 'A PowerShell module for awesome on-stage terminal demos'
...
RequiredModules = @(
    @{ModuleName = 'PSReadLine'; ModuleVersion = '2.2.6'}
)
...
FunctionsToExport = @('Get-Demo', 'Set-Demo', 'Reset-Demo', 'Get-DemoIndex')
